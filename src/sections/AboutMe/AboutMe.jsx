        ...
        <div className='about-me__text-lottie__div'>
            <div className='about-me__text-div'>
                {/* <div className='intro-tags__full-div'> */}
                    ...
                    <br/>
                    <span className='html_tags'>{'< li >'}</span>
                    <p style = {{color : '#FEA400'}} className = 'about-me__text'>Talking about myself I'm an adequately organized and kind of a moody guy. Apart from coding and all other working stuffs I am a guy who loves to spend leisure time gaming, watching movies, roaming around with friends and ahh! at the end partying.</p>
                    <span className='html_tags'>{'</ li >'}</span>
                    <br/>
                    <span className='html_tags'>{'< li >'}</span>
